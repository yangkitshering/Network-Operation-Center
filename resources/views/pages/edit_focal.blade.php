                ...
                <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                    <div class="max-w-xl">
                        ...
                        <form method="POST" action="{{ route('save_focal') }}">
                            @csrf
                            <input type="hidden" name="id" value="{{ $focal->id }}" />
                            <!-- DC list dropdown -->
                            <div class="mt-4">
                                ...
                                <select id="dc_id" class="block mt-1 w-full" name="dc_id" required autofocus>
                                    ...
                                    <option value="{{ $dc->id }}" {{ $focal->dc_id ==
                                        $dc->id ? 'selected' : '' }}>{{ $dc->dc_name}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input id="focal_name" class="block mt-1 w-full" type="text" name="focal_name"
                                    :value="old('focal_name', $focal->focal_name)" required autofocus
                                    autocomplete="focal_name" />
                            ...
                            <div class="mt-4">
                                ...
                                :value="old('email', $focal->focal_email)" required
                                    autocomplete="email" />
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input id="focal_contact" class="block mt-1 w-full" type="text"
                                    name="focal_contact" :value="old('focal_contact', $focal->focal_contact)" required
                                    autofocus autocomplete="focal_contact" />
